...
func (UserPiLayout) SkillPath(name string) string  { return filepath.Join(".pi", "skills", name) }
func (UserPiLayout) PluginPath(name string) string { return filepath.Join(".pi", "plugins", name) }
