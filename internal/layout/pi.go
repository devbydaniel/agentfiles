...
func (l PiLayout) AgentMdEntries() []Entry    { return []Entry{{Path: l.AgentMdPath(), Kind: KindRegular}} }
func (l PiLayout) SkillEntries(name string) []Entry  { return []Entry{{Path: l.SkillPath(name), Kind: KindRegular}} }
func (l PiLayout) PluginEntries(name string) []Entry { return []Entry{{Path: l.PluginPath(name), Kind: KindRegular}} }
